    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <button
            onClick={handleLogin}
            className="px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl w-full sm:w-auto"
          >
            Login to Continue
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-12 sm:mt-20">
          {/* Secure Entry */}
          <div className="bg-white rounded-xl p-5 sm:p-8 shadow-md hover:shadow-lg transition-shadow">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-100 rounded-full flex items-center justify-center mb-4 sm:mb-6 mx-auto">
              <Shield className="w-6 h-6 sm:w-7 sm:h-7 text-blue-600" />
            </div>
            <h3 className="text-base sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 text-center">
              Secure Entry
            </h3>
