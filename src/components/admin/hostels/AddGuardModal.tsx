...
import { AssignmentForm, Hostel, Gate } from './types';
...
export const AddGuardModal: React.FC<AddGuardModalProps> = ({ isOpen, onClose, onSave, hostels, gates }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl max-w-md w-full shadow-2xl">
                <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-xl">
                    <h2 className="text-xl font-bold text-gray-900">New Guard Assignment</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <InputField label="Guard Name" value={form.guard} onChange={(v) => setForm({ ...form, guard: v })} placeholder="Enter guard name" />
