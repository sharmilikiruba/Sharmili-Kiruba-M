...
import { Users, TrendingUp, Calendar as CalendarComp, Download, RotateCcw } from 'lucide-react';

export default function StudentWiseHistory() {
  ...
  const studentData = [
    { name: 'Rahul Sharma', totalVisitors: 12, uniqueVisitors: 4, frequency: '3/month', lastVisit: '2026-01-04' },
    { name: 'Priya Patel', totalVisitors: 8, uniqueVisitors: 3, frequency: '2/month', lastVisit: '2026-01-03' },
    { name: 'Amit Kumar', totalVisitors: 5, uniqueVisitors: 2, frequency: '1.5/month', lastVisit: '2026-01-05' }
  ];
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 p-8 overflow-y-auto">
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Students with Visitors</p>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold">Rahul S.</p>
                    </div>
            ...
            {/* Student-wise History Table */}
            <Card>
              <CardContent className="pt-6">
                <h3 className="text-lg font-semibold mb-6">Student-wise Visitor History</h3>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b-2 border-gray-200">
                        ...
                        <th className="text-center py-3 px-4 font-semibold text-gray-700">Unique Visitors</th>
                        <th className="text-center py-3 px-4 font-semibold text-gray-700">Frequency</th>
                        <th className="text-center py-3 px-4 font-semibold text-gray-700">Last Visit</th>
                      </tr>
                    </thead>
                    <tbody>
                      {studentData.map((row, idx) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-4 px-4 text-center">{row.totalVisitors}</td>
                          <td className="py-4 px-4 text-center">{row.uniqueVisitors}</td>
                          <td className="py-4 px-4 text-center">{row.frequency}</td>
                          <td className="py-4 px-4 text-center">{row.lastVisit}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
