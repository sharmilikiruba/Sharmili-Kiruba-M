...
import { LayoutDashboard, User, FileText, Clock, ArrowLeft, Upload, X, Save, Send } from 'lucide-react';
...
const NewVisitorRequestPage = () => {
  ...
  const menuItems = [
    ...
    { id: 'newrequest', label: 'New Request', icon: FileText },
    { id: 'myrequests', label: 'My Requests', icon: Clock },
  ];
  ...
  const getBreadcrumb = () => {
    if (showNewRequest || activeMenu === 'newrequest') return '/student/new-request';
    switch(activeMenu) {
      case 'profile': return '/student/profile';
      case 'dashboard': return '/student/dashboard';
      case 'myrequests': return '/student/myrequests';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-8">
          {/* Dashboard Page */}
          {activeMenu === 'dashboard' && !showNewRequest && (
            <div>
              <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Dashboard</h1>
                <p className="text-gray-600 mb-6">Welcome to your visitor management dashboard</p>
          ...
          {/* New Visitor Request Form */}
          {(showNewRequest || activeMenu === 'newrequest') && (
            <div>
